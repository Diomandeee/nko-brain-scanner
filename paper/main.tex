...
Through activation profiling (``brain scanning'') of Qwen2-72B and targeted fine-tuning of Qwen3-8B, we demonstrate that:
(1) N'Ko produces systematically different activation patterns than English, with higher sparsity in early processing layers;
...
% PLACEHOLDER: Will be filled with actual brain scan results from Mac5
\textit{[Brain scan results pending---running on Mac5]}
...
\begin{tabular}{clll}
\toprule
\textbf{Rank} & \textbf{Token} & \textbf{Gloss} & \textbf{Freq} \\
\midrule
0 & \textnko{la} & locative & 3,046 \\
1 & \textnko{ka} & completive & 2,326 \\
8 & \textnko{ye} & copula ``is'' & 1,380 \\
19 & \textnko{kan} & language & 870 \\
200 & \textnko{N'Ko} & script name & 143 \\
350 & \textnko{faransi} & France & 74 \\
\bottomrule
\end{tabular}
\caption{Selected BPE merges showing linguistic validity. N'Ko characters cannot be rendered in standard LaTeX; actual Unicode characters are used in the digital version.}
